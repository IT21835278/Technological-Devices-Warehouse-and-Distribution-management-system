...
const AddStaff = () => {
 ...
 // const [staffId,setstaffId] = useState("")
  ...
  return (
    <AdminLayout>
    <div className="add-staff-container-main" style={{ height: '1900px' , width:"1300px",marginBottom: '30px' }}>
...
>
  Full Name :
                  ...
                  <input className="input-field"  value={firstName} onChange={(e) => setfirstName(e.target.value)} required  pattern="[A-Za-z\s]+"  title="Full Name should contain only letters (A-Z or a-z)"/>
                </section>
                
                <section className="input-container">
                        <span className="input-title" style={{
    fontSize: '18px', // Set the font size to 18 pixels
    color: '#0074D9', // Set the text color to blue (#0074D9)
  }}>NIC :</span>
    ...
    color: '#0074D9', // Set the text color to blue (#0074D9)
                ...
                <section className="input-container">
                  <label htmlFor="role" className="input-title" style={{
    fontSize: '18px', // Set the font size to 18 pixels
    color: '#0074D9', // Set the text color to blue (#0074D9)
  }}>Job Role :</label>
                ...
                <section className="input-container">
                  <label htmlFor="other" className="input-title" style={{
    fontSize: '18px', // Set the font size to 18 pixels
    color: '#0074D9', // Set the text color to blue (#0074D9)
