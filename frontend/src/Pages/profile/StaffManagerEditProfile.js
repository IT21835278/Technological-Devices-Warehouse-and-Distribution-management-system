...
import AdminLayout from '../StaffManagePage/Layouts/AdminLayout'


const StaffMagerEditProfile = () => {
  ...
  const saveProfile = async (e) => {
    ...
    try {
      ...
      navigate('/admin/staffManagerProfile');
      setIsLoading(false);
    } catch (error) {
      console.error(error);
      setIsLoading(false);
...
export default StaffMagerEditProfile;
